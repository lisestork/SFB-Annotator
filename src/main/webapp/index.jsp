		...
		<div class="container-fluid">
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
					<li><a role="button" href="#" rel="about"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> About</a></li>
					<li><a role="button" href="#" rel="collections"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Collections</a></li>
					<li><a role="button" href="#" rel="register"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Register</a></li>									        
			        <li>        	 
				 	</li>
			      </ul>
			...
			<section id="register" style="display:block">
				<div class="row">
					<section class="jumbotron text-center">
					 	<div class="container">
					        <h3 class="jumbotron-heading"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Register for annotation</h3>
					        <p class="lead text-muted">Please register: <a href="#" data-toggle="modal" data-target="#login-modal">Register</a></p>
					   	</div>
				    </section> 
				</div>
				<div class="row" >
					<div class="container">
						<image src="images/MMNAT01_B4_F2_V3_Thumbnail.jpg" class="img-responsive center-block" style="filter: alpha(opacity=50)"></image>
					</div>
				</div>
			</section>
			...
			<section id="about" style="display:none">
				<div class="row">
					<section class="jumbotron text-center">
					 	<div class="container">
					        <h3 class="jumbotron-heading"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> About</h3>
			...
			<section id="collections" class="container-fluid" style="display:none" >
				...
				<div class="row">
				 	<section class="jumbotron text-center">
					 	<div class="container" id="collectionsJumbotron">
					        <h3 class="jumbotron-heading"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Collections</h3>
					   	</div>
				    </section>
				...
				<div class="loading" id="loading" style="display:none"></div>
							  ...
							  <div class="row">
							    ...
							    <div class="col-md-2">
							    	<div class="input-group">
								    	<input class="form-control" id="insertedPage" type="text" placeholder="Go to page.."></input>
								    	<span class="input-group-btn">
									        <button id="insert" class="btn btn-default" type="button"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></button>
									    </span>
								    </div>
								 </div>
							    </div>
					...
					<div class="row" id="image" style="display:none;position:relative;">
						<div class="col-md-12">
							<a href="#" id="annotate"> Annotate <span class="glyphicon glyphicon-tags" aria-hidden="true"></span></a>
		...
		<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    	    <div class="modal-dialog">
				<div class="loginmodal-container">
					<h1>Register</h1><br>
				  <form>
					<input type="text" name="firstname" placeholder="First name" value="Lise">
					<input type="text" name="lastname" placeholder="Last name" value ="Stork">
					<input type="text" name="IRI" placeholder = "IRI (e.g. ORCID)" value = "http://orcid.org/0000-0002-2146-4803">
					<input type="text" name="institution" placeholder="Institution" value = "Leiden University">
					<input type="text" name="institutionIRI" placeholder="Institution IRI" value = "https://www.universiteitleiden.nl/">
