...
public class writeAnnotationsToSQL extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String insert = "INSERT INTO Annotations (url, firstname, lastname, class_model, organismID, x, y, height, width) VALUES ('"
					+ url + "','" + firstname + "','" + lastname + "','" + class_model + "','" + organismID + "','" + x
					+ "','" + y + "','" + height + "','" + width + "');";
